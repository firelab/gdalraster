...
#> ℹ output written to: "/tmp/Rtmpgz1vSP/rastcalc20fb617fc494.tif"
...
(ndvi <- calc(expr, list(b4, b5), var.names = c("B4", "B5"), fmt = "MEM",
              ...
              return_obj = TRUE))
#> ℹ output written to: "calce20fba6ffacf"
#> C++ object of class <GDALRaster>
#>   • Driver: In Memory Raster (MEM)
#>   • DSN: "calce20fba6ffacf"
...
calc(expr = expr,
     ...
     out_band = 4,
     write_mode = "update")
#> ℹ output written to: "/tmp/Rtmpgz1vSP/storml_lndscp.tif"
