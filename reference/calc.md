...
#> ℹ output written to: "/tmp/Rtmpk1p4OU/rastcalc20a3364a8b2a.tif"
...
(ndvi <- calc(expr, list(b4, b5), var.names = c("B4", "B5"), fmt = "MEM",
              ...
              return_obj = TRUE))
#> ℹ output written to: "calc20a359e4fc03"
#> C++ object of class <GDALRaster>
#>   • Driver: In Memory Raster (MEM)
#>   • DSN: "calc20a359e4fc03"
...
calc(expr = expr,
     ...
     out_band = 4,
     write_mode = "update")
#> ℹ output written to: "/tmp/Rtmpk1p4OU/storml_lndscp.tif"
