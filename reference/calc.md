...
#> ℹ output written to: "/tmp/Rtmp9e5Mrs/rastcalc1fbc543128f8.tif"
...
(ndvi <- calc(expr, list(b4, b5), var.names = c("B4", "B5"), fmt = "MEM",
              ...
              return_obj = TRUE))
#> ℹ output written to: "calc1fbc5bcbbc7e"
#> C++ object of class <GDALRaster>
#>   • Driver: In Memory Raster (MEM)
#>   • DSN: "calc1fbc5bcbbc7e"
...
calc(expr = expr,
     ...
     out_band = 4,
     write_mode = "update")
#> ℹ output written to: "/tmp/Rtmp9e5Mrs/storml_lndscp.tif"
