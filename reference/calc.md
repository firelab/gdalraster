...
#> ℹ output written to: "/tmp/Rtmpmowyta/rastcalc210a65690774.tif"
...
(ndvi <- calc(expr, list(b4, b5), var.names = c("B4", "B5"), fmt = "MEM",
              ...
              return_obj = TRUE))
#> ℹ output written to: "calc210a7e5ebaf3"
#> C++ object of class <GDALRaster>
#>   • Driver: In Memory Raster (MEM)
#>   • DSN: "calc210a7e5ebaf3"
...
calc(expr = expr,
     ...
     out_band = 4,
     write_mode = "update")
#> ℹ output written to: "/tmp/Rtmpmowyta/storml_lndscp.tif"
