...
#> ℹ output written to: "/tmp/RtmpeQ8MoC/rastcalc21fb8f5eb73.tif"
...
(ndvi <- calc(expr, list(b4, b5), var.names = c("B4", "B5"), fmt = "MEM",
              ...
              return_obj = TRUE))
#> ℹ output written to: "calc21fb2636a59c"
#> C++ object of class <GDALRaster>
#>   • Driver: In Memory Raster (MEM)
#>   • DSN: "calc21fb2636a59c"
...
calc(expr = expr,
     ...
     out_band = 4,
     write_mode = "update")
#> ℹ output written to: "/tmp/RtmpeQ8MoC/storml_lndscp.tif"
