...
#> ℹ open dataset successful on DSN: "/tmp/RtmpCXoVAm/test1.gpkg"
...
if (gdal_version_num() >= gdal_compute_version(3, 7, 0))
  ogrinfo(dsn, "layer2")
#> INFO: Open of `/tmp/RtmpCXoVAm/test1.gpkg'
...
#> ℹ open dataset successful on DSN: "/tmp/RtmpCXoVAm/mtbs_perims.shp"
